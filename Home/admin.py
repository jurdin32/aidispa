...
@admin.register(IndexLineaProductos)
class IndexLineaProductosAdmin(admin.ModelAdmin):
    list_display = [
        'creado_en', 'actualizado_en', 'titulo','estado','mostrar_imagen',
    ]
    readonly_fields = ('mostrar_imagen',)
...
@admin.register(IndexCertificaciones)
class IndexCertificacionesAdmin(admin.ModelAdmin):
    list_display = [
        'creado_en', 'actualizado_en', 'titulo','estado','mostrar_imagen',
    ]
    readonly_fields = ('mostrar_imagen',)
